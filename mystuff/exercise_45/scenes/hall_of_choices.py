...
class HallOfChoices(Scene):
    ...
    def enter(self):
        ...
        print "You once promised your grandpa that you will solve the puzzles and get the gold home."
        print "So here you are, you stood in front of the hall of choices. In the hall, you see Five giant doors."
